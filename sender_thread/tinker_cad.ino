...
unsigned long HeatPeriod[4] = {1000,  // C1T1
                               3000,  // B1T1
                               6000,  // B2T1
                               10000}; // B2C1
...
unsigned long placeHeatedMilli[4] = {0,  // C1T1
                                     0,  // B1T1
                                     0,  // B2T1
                                     0}; // B2C1
...
void threadCoolingCallback(void)
{
     ...
     (toBeActivatedPlaces[3] == false))
  {
    ...
    if(hotPlaces[3] == true)
    {
      unsigned long mustElapseTime = coolingPeriod;

      if(long(currentMillis - placeHeatedMilli[3]) >= mustElapseTime)
      {
        digitalWrite(buttonsLED[3], LOW);
    ...
    if(hotPlaces[2] == true)
    {
      ...
      if(long(currentMillis - placeHeatedMilli[2]) >= mustElapseTime)
      {
        digitalWrite(buttonsLED[2], LOW);
    ...
    if(hotPlaces[1] == true)
    {
      ...
      if(long(currentMillis - placeHeatedMilli[1]) >= mustElapseTime)
      {
        digitalWrite(buttonsLED[1], LOW);
    ...
    if(hotPlaces[0] == true)
    {
      ...
      if(long(currentMillis - placeHeatedMilli[0]) >= mustElapseTime)
      {
        digitalWrite(buttonsLED[0], LOW);
